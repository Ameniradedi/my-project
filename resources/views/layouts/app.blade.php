      ...
      <div class="container-fluid d-flex align-items-center justify-content-between">
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            ...
            <li><a href="/rdvs">Rendez Vous</a></li>
            @endguest
          </ul>
        ...
        @guest
        <div>
          <a href="/register" class="btnFarm">Register</a>
          <a href="/login" class="btnFarm">Login</a>
        </div>
        @else
        <button href="{{ route('logout') }}" class="btnFarm" onclick="event.preventDefault();
    ...
    <footer id="footer" class="footer">
      ...
      <div class="container footer-top">
        ...
        <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
          ...
          <p><strong>Location:</strong> <span>Tunisia</span></p>
        </div>
