...
<head>
    ...
    <title>Home - Invest Farm Bootstrap Temlate</title>
    ...
    <!-- =======================================================
  * Template Name: Invest Farm
  * Updated: Jun 20 2023 with Bootstrap v5.3.0
  * Template URL: https://bootstrapmade.com/Invest Farm-bootstrap-website-template/
  * Author: BootstrapMade.com
  * License: https://bootstrapmade.com/license/
  ======================================================== -->
</head>

<body class="index-page" data-bs-spy="scroll" data-bs-target="#invest Farm">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <nav id="navmenu" class="navmenu">
                <ul>
                    ...
                    <li><a href="#about">Agricultar land</a></li>
                    <li><a href="#services">Gear</a></li>
                    <li><a href="#portfolio">Agricultar Products</a></li>
                    <li><a href="#team">Agricultar studies offices</a></li>
    ...
    <main id="main">
        ...
        <section id="hero" class="hero">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10">
                        <h2 data-aos="fade-up" data-aos-delay="100">Welcome to Invest Farm</h2>
                        <p data-aos="fade-up" data-aos-delay="200"></p>
                    </div>
                    <div class="col-lg-5">
                        <form method="POST" action="{{ route('login') }}" class="sign-up-form d-flex" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="row align-items-xl-center gy-5">
                    ...
                    <div class="col-xl-5 content">
                        ...
                        <p>Ipsa sint sit. Quis ducimus tempore dolores impedit et dolor cumque alias maxime. Enim reiciendis minus
                            et rerum hic non. Dicta quas cum quia maiores iure. Quidem nulla qui assumenda incidunt voluptatem
                            tempora deleniti soluta.</p>
            ...
            <div class="container">
                ...
                <div class="row gy-4 align-items-stretch justify-content-between features-item ">
                    ...
                    <div class="col-lg-5 d-flex justify-content-center flex-column" data-aos="fade-up">
                        ...
                        <ul>
                            <li><i class="bi bi-check"></i> <span>Ullamco laboris nisi ut aliquip ex ea commodo consequat.</span>
                            </li>
